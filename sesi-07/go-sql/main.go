...
func CreateEmployee()  {
	...
	err = db.QueryRow(sqlStatement, "Airell Jordan", "airell@g2maile.com", 23, "IT").
...
func UpdateEmployee()  {
	...
	res, err := db.Exec(sqlStatement, 1, "Ari Cahyono", "aro@gmail.com", "CurDevs", 24)
	if err != nil {
		panic(err)
	}
	...
	fmt.Println("Updated data mount", count)
}
